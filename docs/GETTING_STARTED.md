...
1. Generate or prepare a PNG sprite, sprite sheet, or tileset.
2. Choose an asset category and upload one or more files.
3. Select a tileset region in the sidebar or open the larger picker.
4. Paint tiles, or enable object mode and add platforms, props, pickups, enemies, and exits.
